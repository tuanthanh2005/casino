            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.pages.store') }}" method="POST" id="pageForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control" style="font-size: 1.25rem; font-weight: 600;" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold">{{ __('Page Content') }}</label>
                        <input type="hidden" name="content" id="content-input">
                        <div id="editor" style="height: 400px; font-size: 1rem;"></div>
                    </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="seo_title" class="form-control" placeholder="Optional">
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold">{{ __('SEO Description') }}</label>
                    <textarea name="seo_description" rows="3" class="form-control" placeholder="Optional"></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4">
                ...
                <button type="submit" class="btn btn-primary w-100 fw-bold py-2">{{ __('Save Page') }}</button>
            </div>
        </div>
        </form>
    </div>
