        ...
        <form action="{{ route('admin.rewards.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                       placeholder="VD: Netflix Premium 1 tháng" required>
            </div>

            <div class="mb-3">
                <label class="form-label-admin">Mô tả</label>
                <textarea name="description" class="form-control" rows="3"
                          placeholder="Mô tả chi tiết phần thưởng...">{{ old('description') }}</textarea>
            </div>

            <div class="mb-3">
                <label class="form-label-admin">Giá (Point) <span style="color:var(--danger)">*</span></label>
                <input type="number" name="point_price" class="form-control" value="{{ old('point_price') }}"
                       placeholder="VD: 500" min="1" required>
            </div>

            <div class="mb-3">
                <label class="form-label-admin">Hình ảnh (tùy chọn)</label>
            ...
            <div style="display:flex; gap:0.75rem; margin-top:1.5rem">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check2"></i> Lưu phần thưởng
                </button>
            </div>
        </form>
    </div>
