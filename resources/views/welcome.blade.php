...
<div class="hero">
    <div class="container text-center px-4">
        <span class="badge mb-4">AQUARIUM RESOURCE</span>
        <h1 class="mx-auto" style="max-width: 900px; line-height: 1.05;">Dive Into Your First <span style="color: var(--primary);">Successful</span> Aquarium</h1>
        <p class="mx-auto">Step-by-step guides, fish care tutorials, and setup advice to help you build a stunning underwater world without the stress.</p>
    ...
    <div class="container py-5">
        <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 4rem;">
            <div>
                ...
                <p style="color: #64748b; font-size: 0.875rem;">Step-by-step advice for your aquarium journey.</p>
            </div>
            <a href="/blog" style="color: var(--dark); font-weight: 700; font-size: 0.8125rem; text-decoration: none; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 2px solid var(--primary); padding-bottom: 4px;">View All Posts</a>
        </div>
        ...
        <div class="row g-4 d-flex justify-content-center">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="/category/{{ $category->slug }}" class="d-block p-4 p-lg-5 text-center bg-white border rounded-4 transition-all text-decoration-none shadow-sm hover-shadow" style="border: 1px solid var(--border) !important;">
                    ...
                    <p class="text-secondary mb-0 extra-small" style="font-size: 0.75rem;">{{ $category->posts_count }} Articles</p>
                </a>
            </div>
            @endforeach
        </div>
...
<section class="py-5" style="background: white; border-top: 1px solid var(--border);">
    <div class="container text-center py-5">
        <div class="mx-auto px-3" style="max-width: 600px;">
            <h2 class="fw-black h1 mb-4" style="line-height: 1.1;">Join 15K+ Aquarium Beginners</h2>
            <p style="color: #64748b; line-height: 1.7; margin-bottom: 2.5rem;">Get the absolute best aquarium guides and step-by-step tutorials delivered to your inbox every single week. No spam. Just expert advice.</p>
            <form class="d-flex flex-column flex-sm-row gap-2">
                <input type="email" placeholder="Your primary email address" class="form-control" style="background: #f1f5f9; border: 1px solid var(--border); padding: 0.8rem 1.5rem; border-radius: 99px; text-align: center;">
