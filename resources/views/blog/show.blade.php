    ...
    <div class="py-5" style="background: white;">
        <div class="container" style="max-width: 760px; padding: 4rem 1.5rem;">
            <div class="text-center mb-5">
                <span class="badge"
                    style="background: #f1f5f9; color: #475569; padding: 0.3rem 0.6rem; font-size: 0.65rem;">{{ $category->name ?? 'AQUAKEEPING' }}</span>
                <h1 class="mx-auto"
                    style="font-size: 3.5rem; letter-spacing: -0.05em; font-weight: 900; line-height: 1.05; margin: 1.5rem 0 2rem; color: var(--dark);">
                    {{ $post->title }}
                </h1>
                ...
                <div class="d-flex align-items-center justify-content-center gap-3 py-4 border-top border-bottom"
                    ...
                    <div
                        style="width: 48px; height: 48px; background: #f1f5f9; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1rem; color: var(--dark); border: 2px solid white; box-shadow: var(--shadow-md);">
                        A</div>
            ...
            @if($post->featured_image)
                <figure class="mb-5 py-4">
                    <img src="{{ asset('uploads/posts/' . $post->featured_image) }}" alt="{{ $post->title }}"
                        style="width: 100%; border-radius: 12px; box-shadow: var(--shadow-xl);">
                </figure>
            @endif
