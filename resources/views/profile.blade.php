...
@section('title', 'My Profile - Aquahub')
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2">
                                    <span class="badge" style="background: #ecfeff; color: #0891b2; font-size: 0.75rem; padding: 0.5rem 1rem; border-radius: 99px;">
                                        {{ $user->is_admin ? 'Elite Admin' : 'Community Member' }}
                                    </span>
                                    <span class="badge" style="background: #f1f5f9; color: #475569; font-size: 0.75rem; padding: 0.5rem 1rem; border-radius: 99px;">
                                        Joined {{ $user->created_at?->format('M Y') ?? 'N/A' }}
                                    </span>
                                </div>
                            </div>
                            @if($user->is_admin)
                            <div>
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary px-4">Admin Panel</a>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card h-auto border-0 shadow-sm" style="border-radius: 20px;">
                            <div class="card-body p-4 p-md-5">
                                <h2 class="h5 fw-bold mb-4">Personal Information</h2>
                                <form action="{{ route('profile') }}" method="POST">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <h2 class="h5 fw-bold mb-2">Security Settings</h2>
                                        <p class="text-secondary small mb-4">Leave password fields empty to keep your current password.</p>
                                        
                                        <div class="col-12">
                                            <label class="form-label small fw-bold text-secondary text-uppercase">Current Password</label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-secondary text-uppercase">Confirm New Password</label>
                                        ...
                                        <div class="col-12 mt-5">
                                            <button type="submit" class="btn btn-primary w-100 py-3" style="border-radius: 16px; font-weight: 700; letter-spacing: 0.05em;">SAVE CHANGES</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
