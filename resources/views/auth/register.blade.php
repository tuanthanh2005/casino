...
<head>
    ...
    <title>Get Started - Aquahub.pro</title>
...
<body>
    <div class="auth-card">
        <div class="text-center mb-5">
            ...
            <h1 class="h4 mt-4 fw-bold mb-1">Create an account</h1>
            <p class="text-secondary small">Join our community of aquarium beginners</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4 form-check">
                ...
                <label class="form-check-label small opacity-75" for="terms">I agree to the <a href="/terms" class="text-primary text-decoration-none fw-bold">Terms of Service</a> & <a href="/privacy" class="text-primary text-decoration-none fw-bold">Privacy Policy</a></label>
            </div>

            <button type="submit" class="btn btn-primary w-100 py-3 mb-4" style="border-radius: 12px; font-weight: 700;">Create Free Account</button>
            
            <p class="text-center small text-secondary mb-0">Already have an account? <a href="{{ route('login') }}" class="text-primary text-decoration-none fw-bold">Log in here</a></p>
        </form>
    </div>
